  ...
  return (
    <div className="min-h-screen  bg-gradient-to-b from-slate-50 to-slate-100">
      ...
      <main className="container  mx-auto px-4 py-12">
        <Canvas className="h-screen w-full absolute top-0 left-0 ">
        ...
        <section className="max-w-4xl h-screen flex relative flex-col justify-center items-center mx-auto text-center mb-16">
