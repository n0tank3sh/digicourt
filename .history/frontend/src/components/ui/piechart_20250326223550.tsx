...
export function PieChartComponent() {
    return (
        <Card className="flex flex-col  shadow-none  border-none relative  ">
            <CardHeader className="bg-transparent absolute top-0 left-0">
            ...
            <CardContent className="flex-1  pb-0 ">
                <ChartContainer
                    config={chartConfig}
                    className="mx-auto  h-[500px] aspect-square max-h-[250px] pb-0 [&_.recharts-pie-label-text]:fill-foreground"
                >
                    <PieChart>
