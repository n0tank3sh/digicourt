...
const chartData = [
    { browser: "chrome", visitors: 275, fill: "var(--color-red-500)" },
    { browser: "safari", visitors: 200, fill: "var(--color-green-500)" },
    { browser: "firefox", visitors: 287, fill: "var(--color-yellow-500)" },
]
